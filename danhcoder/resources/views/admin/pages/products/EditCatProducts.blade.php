    ...
    <div class="row">
        <div class="col-12">
            <div class="box-content">
                ...
                <form action="{{ route('updateCatProduct',['id' => $cat->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div class="box-avatar py-2 @if($cat->avatar == null) dl-none @endif">
                                <input id="imgcheck99" type="hidden" class="input-gallery" name="inputGalleryAvatar" value="{!! $cat->avatar !!}">
